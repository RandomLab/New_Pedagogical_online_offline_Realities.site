...
{% image "211122_presentation.jpg", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "211122_presentation_2.jpg", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "211122_presentation_3.jpg", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "211122_presentation_4.jpg", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "miro_notions__20221122.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "IMG_5025.JPG", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "IMG_5045.JPG", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "IMG_5056.JPG", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "IMG_5060.JPG", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "IMG_5292.JPG", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "IMG_5276.JPG", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "IMG_5277.JPG", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "IMG_5279.JPG", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "logologo.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "header.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "wmw1.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "hmw2.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "hmw3.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


Finally, we were able to summarize our findings in the following questions:

{% image "hmwfinal.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


We then started researching other tools that let us send reactions as a competitor analysis.

{% image "competotor.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "emojiclassification.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %})
...
{% image "emojiclassfinal.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "flowchartconcept.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


Then we sketched out first ideas of what our interface and reaction process could look like visually.

{% image "sketch1.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "sketch2.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "sketch3.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "seat.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "bildschirmfoto_2022-12-03_um_17.26.23.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}


{% image "bildschirmfoto_2022-12-03_um_17.26.40.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
...
{% image "bildschirmfoto_2022-12-03_um_17.26.53.png", "The planning of the workshop week in esadse", "(min-width: 30em) 50vw, 100vw" %}
